...
test('SEP iframe', async ({ page }) => {
   ...
   let lastNameInputBox = page.locator("//input[@formcontrolname='lastName']");
    ...
    await cvcInput.fill(process.env.CVC_NUMBER);
      ...
      let countryInput = paymentFrame.locator("//span[text()='United States']");
